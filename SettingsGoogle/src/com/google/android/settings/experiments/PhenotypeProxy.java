...
public class PhenotypeProxy {
    ...
    public static boolean getFlagByPackageAndKey(Context context, String str, String str2, boolean b) {
    ...
    public static String getStringFlagByPackageAndKey(Context context, String str, String str2, String str3) {
        ...
        try {
            acquireUnstableContentProviderClient = context.getContentResolver().acquireUnstableContentProviderClient(PROXY_AUTHORITY);
            bundle2 = acquireUnstableContentProviderClient.call("getStringForPackageAndKey", (String) null, bundle);
            acquireUnstableContentProviderClient.close();
        } catch (Exception e) {
            Log.e("PhenotypeProxy", "Failed to query experiment provider", e);
        } catch (Throwable th) {
        ...
        return bundle2.getString("value", str3);
    }
}
